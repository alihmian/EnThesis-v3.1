...
\begin{proof}
In each case, let $\k_0$ be the relevant Fra\"iss\'e class and let \(\k=\k_0*\mathcal{LO}\) be its free ordered expansion. By construction, every linear ordering on a finite member of $\k_0$ gives a member of $\k$, so every linear ordering on the Fra\"iss\'e limit of $\k_0$ is $\k$-admissible. Therefore \(X_\k=\mathrm{LO}(F_0)\).
